...
<!-- Parts -->
@include('sell.view_TakeOutProducts.allRecord_parts.section_toolbars')
@include('sell.view_TakeOutProducts.allRecord_parts.section_filter')
@include('sell.view_TakeOutProducts.allRecord_parts.section_list')

@include('sell.view_TakeOutProducts.takeOutProducts_parts.section_dimmerPage')
