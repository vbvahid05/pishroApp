            ...
            <div class="main">
                ...
                <div class="row">
                    <div class="col-md-5 pull-right">
                        ...
                        <div class="row">
                            <label class="   containerx ng-binding">
                                <input type="checkbox" ng-click="setPDFStingAction('stng_changeDirection','boolean')" lass="checkboxz" value="25" ng-checked="rtl == 1">
                                <span class="checkmark"></span>
                    ...
                    <div class="col-md-5 pull-right">
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                <input   placeholder="12"   class="inputStyle" ng-model="stng_mainTableFontSize" type="number" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                <input   placeholder="12"   class="inputStyle" ng-model="stng_Desc_fontSize" type="number" >
                            </div>
                            <div class="col-md-2"> {{lang::get('labels.pixel')}}  </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-8 pull-right">
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                <input   placeholder="30"     ng-click="setActive('stng_header_To_InvoiceBody')" class="inputStyle" ng-model="header_To_InvoiceBody" type="number" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                <input placeholder="{{lang::get('labels.default')}}" class="inputStyle"   ng-click="setActive('stng_date_To_sellerInfo')" ng-model="date_To_sellerInfo" type="number" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                <input placeholder="{{lang::get('labels.default')}}" class="inputStyle"    ng-click="setActive('stng_seller_To_InvoiceTable')" ng-model="seller_To_InvoiceTable" type="number" >
                            </div>
                            <div class="col-md-2"> {{lang::get('labels.CM')}} </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                <input placeholder="{{lang::get('labels.default')}}"      ng-click="setActive('stng_InvoiceTable_To_DescriptionTable')" class="inputStyle" ng-model="InvoiceTable_To_DescriptionTable" type="number" >
                            </div>
                            <div class="col-md-2"> {{lang::get('labels.CM')}} </div>
                        </div>
                    <hr>
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                <input ng-ifx="!showLabel_signature_Table_height"  placeholder="90"      ng-click="setActive('stng_signature_Table_height')" class="inputStyle" ng-model="signature_Table_height" type="number" >
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-md-2 pull-right">
                            <div class="btn btn-success" ng-click="allSettingSave()" style="width: 100%;">{{lang::get('labels.save')}}</div>
                        </div>
                        <div class="col-md-2 pull-right">
