@section('section_new_edit_order')
<div ng-show="EditNewOrder_in_Dimmer">
      ...
      <form class="ui form">
        <div class="field">
            <div class="three fields">
              ...
              <div class="field">
                ...
                <input type="hidden" ng-model="Order_id"  readonly>

              </div>
              <label>{{ Lang::get('labels.Orders_ID') }}</label>
              <div class="field">
                <input id="Order_Number" type="text" ng-model="formData.Order_Number"  name="shipping[last-name]" placeholder="{{ Lang::get('labels.Orders_ID') }}">
              </div>
            </div>
        </div>
        ...
        <div class="field">
            <div class="three fields">
              ...
              <div class="field">
                <select id="ord_status"   ng-model="formData.ord_status" class="ui search selection dropdown search-selectx" name="ordStatus" required >
        ...
        <div class="field">
          ...
          <div class="three fields">
              <div class="field" ng-showx="new_form_control"> </div>
              <div class="field" ng-showx="new_form_control">
