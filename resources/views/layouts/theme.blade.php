        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li id="posts" class="treeview">
                    ...
                    <ul  class="treeview-menu">
                        <?php if (!isset($local)) $local='fa' ?>
                        <li><a id="allPosts"  href="{{ url('all-posts/'.$local.'/posts') }}">     <i class="fa fa-user" aria-hidden="true"></i>{{Lang::get('labels.allPosts')}} </a></li>
                        <li><a id="allPosts"  href="{{ url('all-Categories/'.$local.'/posts') }}">     <i class="fa fa-user" aria-hidden="true"></i>{{Lang::get('labels.AllCats')}} </a></li>
